...
namespace Assets.Sources.Controllers.States.Scooter.Implementation
{
    public class SwipeRightScooterMoveState : ScooterMoveState
    {
        ...
        {
            component._scooterRigidbody.MovePosition(component.transform.position + (new Vector3(component._scooterParameters.DodgeSpeed, 0, component._scooterParameters.Speed) * Time.deltaTime));
        }
